...
public class Plan2Activity extends AppCompatActivity {
    ...
    private View.OnClickListener tClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if(v == protein){
                startActivity(new Intent(Plan2Activity.this, ProteinActivity.class));
            }else if(v == fat){
                startActivity(new Intent(Plan2Activity.this, FatActivity.class));
            }else if(v == veggie){
                startActivity(new Intent(Plan2Activity.this, VeggieActivity.class));
            }else if(v == dairy){
                startActivity(new Intent(Plan2Activity.this, DairyActivity.class));
            }else if(v == fruit){
                startActivity(new Intent(Plan2Activity.this, FruitActivity.class));
            }else if(v == carb){
                startActivity(new Intent(Plan2Activity.this, CarbActivity.class));
            }else if(v == snack){
                startActivity(new Intent(Plan2Activity.this, SnacksActivity.class));
            }else{
                startActivity(new Intent(Plan2Activity.this, CondActivity.class));
            }
        }
    };
